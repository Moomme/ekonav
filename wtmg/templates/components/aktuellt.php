<div class="aktuellt-inner">    
    <a href="/ekonav/index.php/aktuellt/"><h3 class="comp-head">AKTUELLT</h3></a>
    <hr class="head-underline"/>
    ...
    <div class="align-boxes">
        <div class="picbox info-box ">
            ...
            <div class="picbox-text">
                <h6>2018-10-14</h6>
                <hr>
                <a href="/ekonav/index.php/single-aktuellt/"><h3> Hej på dig det här är ett test</h3></a>
            </div>
        </div>
        <div class="picbox info-box ">
